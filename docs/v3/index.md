...
- <span style="color: red;">*</span>**value column (integer)**
    - Number of the column containing the value of interest in the input file (1-indexed, 1 is the first column). This value can be the raw affinity or e-score. 
-  <span style="color: red;">*</span>**normalization method (string)**
    - relative, signal-to-noise, or e-score.
...
- **1.0.5** (2026-04-06): Updated for multiple normalization methods.
